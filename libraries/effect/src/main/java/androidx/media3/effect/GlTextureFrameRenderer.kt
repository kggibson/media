...
private constructor(
    ...
    private suspend fun consume(frame: GlTextureFrame) {
        ...
        if (finalShaderProgramWrapper == null) {
            ...
            val finalShaderProgramWrapper =
                createFinalShaderProgramWrapper(frame.format.colorInfo ?: ColorInfo.SDR_BT709_LIMITED)
        ...
        val finalShaderProgramWrapper =
            finalShaderProgramWrapper
                ?: throw IllegalStateException("GlTextureFrameRenderer must be configured")
     ...
     *
     * @param outputColorInfo The color information of the content.
     */
    private fun createFinalShaderProgramWrapper(
        outputColorInfo: ColorInfo
    ): FinalShaderProgramWrapper {
        val configAttributes =
            if (ColorInfo.isTransferHdr(outputColorInfo)) GlUtil.EGL_CONFIG_ATTRIBUTES_RGBA_1010102
            else GlUtil.EGL_CONFIG_ATTRIBUTES_RGBA_8888
    ...
    companion object {
        ...
        /**
         * Creates an [EGLContext] and focus it using a
         * [GlObjectsProvider.createFocusedPlaceholderEglSurface].
         *
         * @return The [EGLContext] and a placeholder [EGLSurface] as a [Pair].
         */
        private fun createFocusedEglContext(
            ...
            return Pair.create<EGLContext, EGLSurface>(eglContext, eglSurface)
        }
    }
}
